            ...
            <tbody>
                @forelse ($errorTrackings as $errorTracking)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('error_trackings.show', $errorTracking->id) }}"
                                class="btn btn-info btn-sm">View</a>
                            <a href="{{ route('error_trackings.edit', $errorTracking->id) }}"
                                class="btn btn-warning btn-sm">Edit</a>

                            <form action="{{ route('error_trackings.destroy', $errorTracking->id) }}" method="POST"
