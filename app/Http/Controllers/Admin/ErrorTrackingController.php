...
class ErrorTrackingController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.error_trackings.index', compact('errorTrackings'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.error_trackings.create', compact('developers', 'projects'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('error_trackings.index')->with('success', 'Error tracking entry created successfully.');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('error_trackings.index')->with('success', 'Error tracking entry updated successfully.');
    }
    ...
    public function destroy(ErrorTracking $errorTracking)
    {
        ...
        return redirect()->route('error_trackings.index')->with('success', 'Error tracking entry deleted successfully.');
    }
}